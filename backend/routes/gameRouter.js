...
import { validateAnswer, validateGuess, validateUpdateGame, validateGameSettings } from "../middleware/validators.js";
...
router.post("/me/new", validateGameSettings, validateAnswer, gameController.createGame);
